...
const AI_RESPONSES: Record<string, string> = {
  ...
  'default': 'Tôi là AI trợ lý CodeMind AI! Tôi có thể giúp bạn với: biến, hàm, vòng lặp, if/else, mảng, object, promise, async/await. Hãy hỏi tôi bất cứ điều gì về lập trình!',
};
...
export const AIAssistant = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Xin chào! Tôi là trợ lý AI của CodeMind AI. Bạn cần giúp gì về lập trình?',
      timestamp: new Date(),
    },
  ]);
