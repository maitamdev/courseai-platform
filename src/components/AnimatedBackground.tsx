export const AnimatedBackground = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="absolute w-20 h-20 border-4 border-emerald-400/30 rounded-full animate-float-slow bottom-20 right-1/3"></div>
      <div className="absolute w-28 h-28 border-4 border-green-400/30 rounded-lg animate-float-medium top-1/3 right-1/4 rotate-45"></div>
