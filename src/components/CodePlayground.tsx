      ...
      <div className="grid lg:grid-cols-2 divide-x divide-gray-700">
        ...
        <div className="relative">
          <div className="flex items-center justify-between px-4 py-2 bg-gray-800/30 border-b border-gray-700">
            ...
            <div className="flex items-center gap-2">
              <button onClick={copyCode} className="p-1.5 hover:bg-gray-700 rounded" title="Copy">
                {copied ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-gray-400" />}
              </button>
              <button onClick={resetCode} className="p-1.5 hover:bg-gray-700 rounded" title="Reset">
                <RotateCcw className="w-4 h-4 text-gray-400" />
              </button>
              <button onClick={downloadCode} className="p-1.5 hover:bg-gray-700 rounded" title="Download">
          ...
          <textarea
            ...
            className="w-full h-80 p-4 bg-gray-900 text-green-400 font-mono text-sm resize-none focus:outline-none"
            spellCheck={false}
          />
        </div>
        ...
        <div>
          ...
          <div className="h-80 p-4 bg-gray-950 overflow-auto">
            {output === 'HTML_PREVIEW' ? (
              <iframe
                srcDoc={code}
              ...
              <p className="text-gray-500 text-sm">Nhấn "Chạy" để xem kết quả...</p>
            )}
          </div>
        </div>
      </div>
